      ...
      case 'calendar':
        return (
          <div className='text-black dark:text-white'>
            <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">Calendrier de collecte</h2>
            {selectedCompany ? (
              <div>
                ...
                <div className="max-w-md mx-auto p-4 border rounded-lg shadow-lg">
                  <form onSubmit={handleUpload}>
                    <h2 className="text-lg font-semibold mb-4 text-black dark:text-white">Publier vos dechets </h2>
      ...
      <div className="flex justify-around">
        {[
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center p-2 ${activeTab === tab.id ? 'text-primary' : 'text-gray-500'
              }`}
          >
            {tab.icon}
